...
var popUpModal = document.querySelector('[data-popup-modal]');
...
function showPopUp() {
  ...
  var openButtonHendler = function openButtonHendler(evt) {
    if (window.window.innerHeight > popUpModal.clientHeight) {
      evt.preventDefault();
